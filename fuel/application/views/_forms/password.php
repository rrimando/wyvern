...
<div class="form-group<?php echo isset($group_class) ? ' ' . $group_class : ''; ?>">
    ...
    <input type="password" class="form-control<?php echo isset($classes) ? ' ' . $classes : ''; ?>"<?php echo isset($name) ? " name='{$name}'" : " name='{$id}'"; ?> id="<?php echo isset($id) ? $id : ''; ?>" value="<?php echo isset($value) ? $value : ''; ?>" placeholder="<?php echo isset($placeholder) ? $placeholder : ''; ?>"<?php echo isset($required) ? " required" : ''; ?>/>
