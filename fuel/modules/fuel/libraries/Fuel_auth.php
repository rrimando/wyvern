...
class Fuel_auth extends Fuel_base_library {
    ...
    public function can_access() {
        ...
        return ($this->fuel->config('admin_enabled') AND ( empty($restrict_ip) OR ( !empty($restrict_ip) AND $this->check_valid_ip($restrict_ip)))
                );
    }
    ...
    public function has_permission($permission, $type = '') {
        if ($this->is_super_admin())
            return TRUE; // super admin's control anything
