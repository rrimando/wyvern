    ...
    public function info($prop = NULL) {
        ...
        if (empty($this->_info)) {
            ...
            if (empty($this->_info['display_field'])) {
                ...
                if (empty($this->_info['display_field']) && !empty($this->_info[1]))
                    $this->_info['display_field'] = $this->_info[1]; // usually the second field is the display_field... first is the id
            }
        }
        if (empty($prop)) {
            return $this->_info;
